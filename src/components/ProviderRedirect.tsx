  ...
  return (
    <div style={{ minHeight: '100vh', display: 'flex', flexDirection: 'column', backgroundColor: '#fff', fontFamily: '"Segoe UI", "Helvetica Neue", Arial, sans-serif' }}>
      <div style={{ flex: 1, display: 'flex', flexDirection: 'column', padding: '40px 48px' }}>
        ...
        <h1 style={{ fontSize: '24px', fontWeight: 600, color: '#1b1b1b', marginTop: '24px', marginBottom: '16px' }}>
          Trying to sign you in
        </h1>

        {/* Animated dots */}
        <div style={{ display: 'flex', gap: '6px', marginBottom: '20px', marginLeft: '4px' }}>
          {[0, 1, 2, 3, 4].map((i) => (
            <div
              key={i}
              style={{
        ...
        <button type="button" onClick={onCancel} style={{ color: '#0067b8', textDecoration: 'none', fontSize: '15px', background: 'none', border: 'none', padding: 0, cursor: 'pointer' }}>
          Cancel
        </button>
      ...
      {/* Microsoft Footer */}
      <div style={{ padding: '12px 24px', fontSize: '12px', display: 'flex', gap: '16px' }}>
